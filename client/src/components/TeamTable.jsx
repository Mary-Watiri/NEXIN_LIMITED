    ...
    return (
      <div>
        ...
        <table className="min-w-full border m-3 border-orange-500">
          <thead>
            <tr className="bg-orange-900 border-orange-500 ">
          ...
          <tbody>
            {tableItems.map((tableItem) => (
              <tr key={tableItem.id} className="border-t border-orange-700">
                <td className="text-xl font-medium py-2 border-orange-500 px-4 border-r">{tableItem.id}</td>
                <td className="text-xl font-medium py-2 border-orange-500 px-4 text-emerald-500 border-r">{`${tableItem.first_name} ${tableItem.last_name}`}</td>
